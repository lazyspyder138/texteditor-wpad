...
main_application.wm_iconbitmap('C:\\Users\\lenovo\\Desktop\\WpadModule\\icon.ico')
...
main_menu.add_cascade(label='Views', menu=view)
...
pdf_btn.grid(row=0,column=9,padx=5)
...
#font family and font size functionalty
...
def convert():
    ...
    pdf.cell(0, 0, txt=content, ln=1, align="L")
    pdf.output("simple_demo.pdf")

pdf_btn.configure(command=convert)
...
def save_file(event=None):
    ...
    try:
        if url:
            ...
            url = filedialog.asksaveasfile(mode = 'w', defaultextension='.txt', filetypes=(('Text File', '*.txt'), ('All files', '*.*'),('Python', '*.py'),('Pdf', '*.pdf'),('C++', '*.cpp')))
...
main_application.bind("<Control-Alt-c>", save_as)
